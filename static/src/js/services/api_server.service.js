app.factory('apiServerService',function ($http, $q) {
    return {
        ...
        call_kw: function (p_args, p_kwargs, p_method, p_model) {
            ...
            $http.post('/web/dataset/call_kw', {
                ...
                defered.reject("Error de conexion con el servidor\n"+err.statusText);
            });
            return promise;
        },
        //llamada a la accion de un boton
        call_button: function (p_args, p_context_id, p_domain_id, p_method, p_model) {
            let defered = $q.defer();
            let promise = defered.promise;
